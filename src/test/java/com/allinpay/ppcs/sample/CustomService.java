...
import com.gsccs.rop.utils.MainErrorType;
import com.gsccs.rop.utils.RopUtils;
...
//        form.add("fileType", "EXCEL");
    ...
    /**
     * 测试自定义的类型转换器{@link com.gsccs.rop.sample.converter.TelephoneConverter}
     */
    @Test
    ...
    /**
     * 验证内部格式为XML的请求参数会正确绑定到RopRequest的内部属性对象中，参见{@link com.gsccs.rop.sample.request.CreateUserRequest#address}
     *
     * @see com.gsccs.rop.sample.request.Address
     */
    @Test
...
//        form.add("favorites", "\"aa\",\"bb\",\"cc\"");
    ...
    /**
     * 由于{@link com.gsccs.rop.sample.request.CreateUserRequest#password}标注了{@link com.gsccs.rop.annotation.IgnoreSign},所以Rop
...
//        form.add("sign", sign);
     ...
     * 参见{@link com.gsccs.rop.sample.request.CreateUserRequest#salary}
     */
    @Test
     ...
     * {@link UserService#addUser(com.gsccs.rop.sample.request.CreateUserRequest)}的权限，而sessionId为mockSessionId2时则没有这个权限。
     * 将返回会话错误的响应报文。
     */
    @Test
    ...
    /**
     * “jhon”是{@link UserService#addUser(com.gsccs.rop.sample.request.CreateUserRequest)} 服务方法预留的用户名，
     * 验证其会返回正确的业务错误码。
     */
    @Test
